...
class TrainConfig:
    ...
    # rename count/rate is always logged; setting this directory additionally dumps one
    # before/after PNG per epoch, on that epoch's last training step. Empty = no images.
