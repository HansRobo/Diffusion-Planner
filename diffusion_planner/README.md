...
- The DP-native progress term is gated by the paper risk score, so critical TTC, THW, or
  occupancy cannot be traded for progress and rear collisions retain continuous attenuation.
