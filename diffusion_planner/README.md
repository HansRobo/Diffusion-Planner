...
- The DP-native progress term is gated by the paper safety score: active collisions receive zero
  progress credit and rear collisions retain the paper's attenuation.
