...
VALID_LIST="${VALID_LIST:?VALID_LIST must be set to a path_list_valid.json file}"
...
exec "${PYTHON_BIN:-$REPO_ROOT/.venv/bin/python}" scripts/visualize_attention_prediction_video.py "${args[@]}"
